...
import (
	...
	"github.com/daiteo/relint/rules/fmt001"
	"github.com/daiteo/relint/rules/fmt002"
	"github.com/daiteo/relint/rules/fmt003"
	"github.com/daiteo/relint/rules/fmt004"
	"github.com/daiteo/relint/rules/fmt005"
	"github.com/daiteo/relint/rules/fmt006"
	"github.com/daiteo/relint/rules/fmtfix"
	"github.com/daiteo/relint/rules/lint001"
	"github.com/daiteo/relint/rules/lint002"
	"github.com/daiteo/relint/rules/lint003"
	"github.com/daiteo/relint/rules/lint004"
	"github.com/daiteo/relint/rules/lint005"
	"github.com/daiteo/relint/rules/lint006"
	"github.com/daiteo/relint/rules/lint007"
	"github.com/daiteo/relint/rules/lint008"
	"github.com/daiteo/relint/rules/lint009"
	"github.com/daiteo/relint/rules/lint010"
	"github.com/daiteo/relint/rules/lint011"
	"github.com/daiteo/relint/rules/lint012"
	"github.com/daiteo/relint/rules/lint013"
	"github.com/daiteo/relint/rules/lint014"
	"github.com/daiteo/relint/rules/lint015"
	"github.com/daiteo/relint/rules/lint016"
	"github.com/daiteo/relint/rules/lint017"
	"github.com/daiteo/relint/rules/lint018"
	"github.com/daiteo/relint/rules/lint019"
	"github.com/daiteo/relint/rules/lint020"
	"github.com/daiteo/relint/rules/lint021"
	"github.com/daiteo/relint/rules/lint022"
	"github.com/daiteo/relint/rules/lint023"
	"github.com/daiteo/relint/rules/lint024"
	"github.com/daiteo/relint/rules/lint025"
	"github.com/daiteo/relint/rules/lint026"
	"github.com/daiteo/relint/rules/lint027"
	"github.com/daiteo/relint/rules/lint028"
	"github.com/daiteo/relint/rules/lint029"
	"github.com/daiteo/relint/rules/lint030"
	"github.com/daiteo/relint/rules/lint031"
	"github.com/daiteo/relint/rules/lint032"
)
